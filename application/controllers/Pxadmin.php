		...
		public function send_mail_reject($id_foto,$memberid)
		{
			...
			foreach ($foto->result()as $x)
			 $config=array(
		                 ...
		                 $this->email->message("
Judul/Deskripsi : ".$x->judul."
<img width='300px' src=".base_url("upload/mini/$x->mini")."><br>

Hi ".$row->nama."<br>

Dengan email ini kami memberitahukan bahwa foto / vektor anda tersebut belum bisa kami terima, 

karena memiliki satu atau lebih kesalahan di bawah ini :<br>

<b>- Blur atau Out Of Focus</b><br>

Foto harus focus atau ketika focus ada area kecil, usahakan pakai Depth Of Field yang besar untuk 
...
Penggunaan special effect seperti tulisan, watermark atau efek pada foto dilarang.<br>

<b>- Size Problem</b><br>

Pastikan foto anda memenuhi kriteria size yaitu minimal 4 Mega Pixel (2240x1680)<br>

<b>- Melanggar hak cipta/ tidak original</b><br>

Karya foto / vector yang Anda buat haruslah asli dan original karya Anda. Anda tidak diperbolehkan 

meniru, menjiplak, atau membuat karya foto / vector yang terlihat sama dengan karya foto / vector 

yang sudah pernah dibuat sebelumnya.<br>

<b>- Tidak memiliki kelengkapan File yang dibutuhkan</b><br>

Karya nvector Anda harus diupload dalam dua jenis file, yaitu : image file (.JPG) size minimal 4 MB 

dan vector file (.EPS)<br>

<b>- Mengandung SARA (Suku, Agama, dan Ras) atau Pornografi</b><br>

Anda tidak diperbolehkan mengupload karya foto / vector yang mengandung unsur SARA atau 

pornografi.
<br>
<b>- Kualitas karya foto / vector di bawah standar yang kami cari</b><br>

Jika ada hal yang kurang jelas, silahkan hubungi kami di <a href='mailto:support@pixtox.com'>support@pixtox.com</a>.

Kami tunggu upload karya foto/vektor anda yang selanjutnya, selamat mencoba.<br>
