	...
	*/
	class Contributor extends CI_Controller
	{
		...
		public function newUpload()
		{
			...
			$foto=$session['foto'];
				...
				elseif($app_status==2)
				{
					...
					Terima kasih telah meng-upload foto di pixtox.com, saat ini foto anda akan melalui proses penilaian oleh admin paling lambat 7x24 jam.
					</div>";
		...
		public function uploadImage()
		{
			...
			$config['allowed_types'] = 'jpg|ips|eps';
			$config['encrypt_name'] = TRUE;
