<div class="panel panel-default">
	...
	<form id="upload" method="post" action="<?php echo base_url("contributor/do_konfirmasi");?>">
		...
		<div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<input min='0' type="text" name="jumlah_bayar" id="jumlah_bayar" class="form-control">
