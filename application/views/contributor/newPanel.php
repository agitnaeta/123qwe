			          	...
			          	<center>
					            ...
					            <select class="form-control" name="f_type" id="f_type">
					              ...
					              <div class="form-group">
					              	...
					              	<label>Foto</label>
					                <input tabindex="2" class="form-control" type="file" name="image" id="image" accept="image/jpeg">
					                <label class="eps">Vektor File (.eps)</label>
					                 <input   tabindex="2" class="form-control eps" type="file" name="eps" id="eps" accept="image/x-eps">
	...
	<script type="text/javascript">
		$(document).ready(function  () {
			...
			$('#image').focus(function  () {
				$(this).after('<p class="text-right" id="image-wp">Format foto harus .jpg dengan Resolusi minimum 4MP </p>');
			})
			$('#image').blur(function  () {
				$('#image-wp').remove();
			})
...
$('#eps').focus(function  () {
				$(this).after('<p class="text-right" id="image-wp">Format foto harus .eps dengan Resolusi minimum 4MP </p>');
			})
			$('#eps').blur(function  () {
				$('#image-wp').remove();
			})
