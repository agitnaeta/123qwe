			...
			<div class="col-md-8">
				<div class="panel">
					...
					<div class="col-md-4">
						...
						<a href="<?=base_url('login');?>" class="btn btn-warning btn-block"><i class="fa fa-shopping-cart"></i> Buy</a>
						</div>
						</div>
					</div>
					<?php endforeach;?>
				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<input type="hidden" name="status" value="C">
							...
							<input required type="checkbox"> Dengan ini menyetujui <a href="<?=base_url("term");?>">Syarat & Ketentuan</a> Pixtox.com
						...
						<div class="pull-right">
							...
							<a href="<?php echo base_url("member"); ?>" class="btn btn-default"><i class='fa fa-backward'></i> Cancel</a>
						</div> 
					</div>
				</div>
			</div>
