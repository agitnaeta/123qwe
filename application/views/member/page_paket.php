...
<script type="text/javascript">
	$(document).ready(function  () {
		$('.paket').click(function  () {
			...
			$.post('<?php echo base_url("member/getDataPaket");?>',{kode_paket:kode_paket},function  (data) {
		...
		$('#kode_paket').click(function  () {
			...
			else
			{
				if (confirm("Apakah Anda yakin ingin membeli paket ini?")) {
					$.post('<?php echo base_url("member/beli_paket");?>',{kode_paket,kode_paket},function  (data) {
					$('.pemesanan').html(data)
