...
<section class='footer' id='footer'>
	...
	<div class="col-md-1"></div>
		...
		<div class="col-md-2">
			...
			<ul class="nav">	
				<li>
					<a class="white" href="mailto:hrd@pixtox.com"><i class='fa fa-envelope'></i> hrd@pixtox.com </a>
				</li>
			</ul>
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-2">
			...
			<ul class="nav">	
				<li>
					<a class="white" href="mailto:info@pixtox.com"><i class='fa fa-envelope'></i> info@pixtox.com </a>
				</li>
			</ul>
		</div>
		<div class="col-md-1">
