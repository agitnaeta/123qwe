				...
				<h1 class="text-center">Million Image From The World</h1>
					<div class="tabbable" id="tabs-486289">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#panel-818320" data-toggle="tab">Stock Photos</a>
							</li>
							<li>
								<a href="#panel-327968" data-toggle="tab">Stock Vectors </a>
							</li>
						</ul>
						          ...
						          <div class="row">
						            ...
						            <?php kosong($photo->result());?>
						              <div id="owl-demo" class="owl-carousel">
						                ...
						                <?php endforeach;?>
<div class="">
						             		<a href="<?php echo base_url("image/photo");?>">
							                <div class="">
							                	<div class="items">
							                	<h4>Load More <i class="fa fa-forward"></i> </h4>
							                </div>		
							                </div>					               
							                </a>
						             	</div>
									...
									<div class="panel-body">
										<div class="col-md-12">
											<ul class="list-inline">
												...
												<li>#<a href="<?=base_url("image/category/".str_replace('/','_',pregimage($row->nama))."");?>"><?=$row->nama;?> </a></li>
												<?php endforeach;?>
											</ul>
										</div>
									</div>
						        ...
						        <div class="container">
						          <div class="row">
						            <div class="span12">
						                ...
						                <?php endforeach;?> 
<div class="">
						             		<a href="<?php echo base_url("image/vektor");?>">
							                <div class="">
							                	<div class="items">
							                	<h4>Load More <i class="fa fa-forward"></i> </h4>
							                </div>		
								  ...
								  <div class="modal-dialog modal-sm">
								    ...
								    <div class="modal-content">
								      <div class="modal-header">
								        ...
								        <h4 class="modal-title black" >Pendaftaran</h4>
								      </div>
								      <div class="modal-body text-center">
								        <p id="syaratKetentuan" class="black">
...
<section class='footer' id='footer'>
	...
	<div class="col-md-1"></div>
		...
		<div class="col-md-2">
			...
			<ul class="nav">	
				<li>
					<p class="white" ><i class='fa fa-envelope'></i> hrd@pixtox.com </p>
				</li>
			</ul>
		</div>
		<div class="col-md-2">
		...
		<div class="col-md-2">
			...
			<ul class="nav">	
				<li>
					<p class="white" ><i class='fa fa-envelope'></i> info@pixtox.com </p>
				</li>
			</ul>
		</div>
		<div class="col-md-1">
...
<script type="text/javascript">
	$(document).ready(function  () {
		var images = <?=$bg;?>;
		 $('.intro').css({
		 	'background-image': 'url(<?php echo base_url("upload/bg/");?>/' + images[Math.floor(Math.random() *      images.length)] + ')',
