		...
		<?php foreach ($member->result() as $row):?>
			<table class="table">
				<thead>
					...
					<tr><td>Member ID</td><td><input name="memberid" class="form-control" value="<?=$row->memberid;?>" readonly></td></tr>
					<tr><td>Username</td><td><input name="username" class="unlock form-control" value="<?=$row->username;?>" readonly></td></tr>
					<tr><td>Password</td><td><input name="password" class="unlock form-control" value="" readonly></td></tr>
					...
					<tr><td>Paket</td><td>
						...
						<span class="input-group-addon"><?=$row->paket;?></span>
						<select name="paket" class="unlock form-control">
							<option value="<?=$row->paket;?>">Default</option>
							<option value="">Free</option>
							<option value="">6 Moth</option>
						</select>
						</div>
					</td></tr>
